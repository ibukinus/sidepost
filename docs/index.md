...
- [requirements/](./requirements/index.md) — 要件定義書
- [design/](./design/index.md) — 設計文書（アーキテクチャ、Lexicon定義など）
- [adr/](./adr/index.md) — Architecture Decision Records（意思決定の記録）
- [guides/](./guides/index.md) — 開発・運用の手順とルール
